...
import com.example.ar_ruler_abdulsamie.fragment.RulerUnit.Companion.mmToPx
...
class RulerCalibrationView : View {
    ...
    init {
        ...
        colorPaint.color = context.resources.getColor(R.color.windowsBackground)

        textPaint.textSize = dpTOpx(20f)
        textPaint.color = context.resources.getColor(R.color.capsule)
